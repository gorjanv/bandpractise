...
import { EditButton } from '@/components/shared/EditButton.styled';
...
export const SongListMyRating = styled.div<{ $hasRated: boolean }>`
  display: flex;
  align-items: center;
  gap: 0.5rem;
  margin-top: 0.25rem;
  font-size: 0.75rem;
  font-weight: 600;
  color: ${props => props.$hasRated ? theme.colors.emerald[400] : 'white'};
`;

export const SongListMyRatingValue = styled.span<{ $hasRated: boolean }>`
  color: ${props => props.$hasRated ? theme.colors.emerald[400] : theme.colors.slate[700]};
`;
...
export { EditButton as TileEditButton };
...
export const VersionItem = styled.button<{ $isSelected: boolean }>`
  background: none;
  border: none;
  padding: 0;
  cursor: pointer;
  transition: all ${theme.transitions.normal} ease;
  font-size: 0.875rem;
  color: ${props => props.$isSelected ? theme.colors.purple[400] : theme.colors.slate[400]};
  font-weight: ${props => props.$isSelected ? 600 : 400};
  text-decoration: ${props => props.$isSelected ? 'underline' : 'none'};
  text-underline-offset: 0.25rem;
  
  &:hover {
    color: ${props => props.$isSelected ? theme.colors.purple[400] : theme.colors.slate[300]};
    text-decoration: underline;
  }
`;

// Voting section styled components
export const VoteRatingSection = styled.div`
  margin-top: 1.5rem;
  margin-bottom: 1rem;
`;

export const VoteRatingHeader = styled.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  margin-bottom: 0.75rem;
...
export const VoteRatingLabel = styled.label`
  font-size: 0.875rem;
  font-weight: 600;
  color: ${theme.colors.slate[300]};
`;

export const VoteRatingDisplay = styled.div`
...
export const VoteRatingValue = styled.span`
  font-size: 1.5rem;
  font-weight: 700;
...
export const VoteSliderContainer = styled.div`
  position: relative;
`;

export const VoteSlider = styled.input.attrs({ type: 'range' })<{ $value: number }>`
  width: 100%;
  height: 0.75rem;
...
export const VoteSliderLabels = styled.div`
  display: flex;
  justify-content: space-between;
  font-size: 0.75rem;
  color: ${theme.colors.slate[500]};
...
export const VoteCommentSection = styled.div`
  margin-bottom: 1rem;
`;

export const VoteCommentLabel = styled.label`
  display: block;
  font-size: 0.875rem;
  font-weight: 600;
  color: ${theme.colors.slate[300]};
...
export const VoteCommentTextarea = styled.textarea`
  width: 100%;
...
export const RatingTabs = styled.div`
  display: flex;
  gap: 0.5rem;
  margin-top: 1rem;
  margin-bottom: 1rem;
...
export const RatingTab = styled.button<{ $isActive: boolean }>`
  background: none;
  border: none;
  padding: 0.75rem 1.5rem;
  font-size: 0.875rem;
  font-weight: ${props => props.$isActive ? 600 : 400};
  color: ${props => props.$isActive ? theme.colors.purple[400] : theme.colors.slate[400]};
  cursor: pointer;
  transition: all ${theme.transitions.normal} ease;
  border-bottom: 2px solid ${props => props.$isActive ? theme.colors.purple[400] : 'transparent'};
  margin-bottom: -1px;
  
  &:hover {
    color: ${props => props.$isActive ? theme.colors.purple[400] : theme.colors.slate[300]};
  }
`;
